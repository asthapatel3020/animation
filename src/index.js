...
function createProton() {
  ...
  emitter.addInitialize(new Proton.Life(5, 5)); // see the life span of jelly beans comes out
  emitter.addInitialize(
    new Proton.V(
      new Proton.Span(0.9, 6),
      new Proton.Span(0.5, 360, true),
      "polar"
    )
  );
  emitter.addBehaviour(new Proton.Alpha(10));
  ...
  // );
  emitter.addBehaviour(
    new Proton.Scale(Proton.getSpan(0.007, 0.001), Proton.getSpan(1, 1))
  ); 
